...
public class Menu {
    ...
    private void menu_to_admin(String email) throws IOException {
        ...
        System.out.println("\t\t\t\t--------------------------------");
        System.out.println("\t\t\t\t6 - Listar Jogos Criados por mim");
        System.out.println("\t\t\t\t--------------------------------");
        System.out.println("\t\t\t\t7 - Listar Utilizadores Online");
        System.out.println("\t\t\t\t--------------------------------");
        System.out.println("\t\t\t\t8 - Listar Todos os Users");
        System.out.println("\t\t\t\t--------------------------------");
        System.out.println("\t\t\t\t9 - Terminar Jogo");
        System.out.println("\t\t\t\t--------------------------------");
        System.out.println("\t\t\t\t0 - Voltar");
        System.out.println("\t\t\t\t--------------------------------");
        int opcao;
        ...
        switch (opcao) {
            ...
            case 6:
                limparEcra(3);
                List<Jogo> aux3 = ca.listaJogosCriados(email);
            ...
            case 7:
                limparEcra(3);
                List<User> aux4 = ca.listaUsersOn();
                if(aux4.size() > 0){
